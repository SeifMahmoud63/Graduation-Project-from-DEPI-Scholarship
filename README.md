As part of the DEPI graduation project, we worked on a sales platform called Olist, based in Brazil. We collected data from 9 CSV files, followed by thorough data exploration and preparation.
